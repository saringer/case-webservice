...
import de.agdb.custom_components.modal_windows.SetTimeLocationWindow;
...
@UIScope
@SpringView(name = EventTimesLocationsView.VIEW_NAME)
public class EventTimesLocationsView extends VerticalLayout implements View {
    ...
    public EventTimesLocationsView() {
    ...
    private FormLayout buildContent(DateWrapper day) {
        ...
        Label header = new Label(day.getDay().format(DateTimeFormatter.ofPattern("EEEE, dd.MM.yyyy", Locale.UK))
        );
