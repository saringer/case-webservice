...
public class OAuthData {
	 ...
	 */
	public OAuth1RequestToken createNewRequestToken() throws ExecutionException, InterruptedException {
		if (isOAuth20()) {
			return null;
		}
		try {
	 ...
	 */
	public void setVerifier(OAuth1RequestToken requestToken, String verifier) throws ExecutionException, InterruptedException {
		try {
			Token at;
			synchronized (this) {
				if (isOAuth20()) {
