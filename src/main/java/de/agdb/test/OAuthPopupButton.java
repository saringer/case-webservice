 ...
 */
public class OAuthPopupButton extends CssLayout {
	...
	private void createSyncButton() {
		setSizeUndefined();
		Label buttonCaption = new Label(VaadinIcons.REFRESH.getHtml() + " Synchronize");
		buttonCaption.setSizeUndefined();
		buttonCaption.setContentMode(ContentMode.HTML);
		//buttonCaption.addStyleNames("inline");
		//buttonCaption.setIcon(VaadinIcons.REFRESH);
		addComponent(buttonCaption);
